...
class RobotAssistente:
                ...
                for itens in lista:
                    ...
                    for item in lista_itens:
                        if '/pesquisa' in item:
                            print(lista_itens)
                            nome = lista_itens[0]
                            pesquisa = item.split('/pesquisa')[1:]
                            print(nome, 'Pesquisou', pesquisa[0])
                            self.pesquisar_wikipedia(nome, pesquisa[0])
    ...
    def pesquisar_wikipedia(self, contato, pesquisa):
        try:
            ...
            mensagem = wikipedia.summary(pesquisa)
            # mensagem = f'O site Wikipedia esta muito lento, Por favor aguarde seu retorno tentando novamente mais ' \
            #            f'tarde\n' \
            #            f'Obrigado pela sua pesquisa sobre: {pesquisa}'
            print(mensagem)
        except Exception as err:
